 ...
 */
final class Version20221002100812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE anatomical_entity (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, parent_term_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, ontology_id VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_4759D4CD2900468 (ontology_id), INDEX IDX_4759D4CB03A8386 (created_by_id), INDEX IDX_4759D4C7C6441BA (parent_term_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE biological_status (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, code VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_8D91CD87B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE breeding_method (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, parent_term_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, ontology_id VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_2C31C921D2900468 (ontology_id), INDEX IDX_2C31C921B03A8386 (created_by_id), INDEX IDX_2C31C9217C6441BA (parent_term_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ci_criteria (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, parent_term_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, ontology_id VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_F195A420D2900468 (ontology_id), INDEX IDX_F195A420B03A8386 (created_by_id), INDEX IDX_F195A4207C6441BA (parent_term_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE collecting_source (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, code VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_A59B88EDB03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE developmental_stage (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, parent_term_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, ontology_id VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_E0FDDCD4D2900468 (ontology_id), INDEX IDX_E0FDDCD4B03A8386 (created_by_id), INDEX IDX_E0FDDCD47C6441BA (parent_term_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE growth_facility_type (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, parent_term_id INT DEFAULT NULL, ontology_id VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_C007F60CB03A8386 (created_by_id), INDEX IDX_C007F60C7C6441BA (parent_term_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE gwasmodel (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, parent_term_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, ontology_id VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_C95EDDB0D2900468 (ontology_id), INDEX IDX_C95EDDB0B03A8386 (created_by_id), INDEX IDX_C95EDDB07C6441BA (parent_term_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE gwasstat_test (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, parent_term_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, ontology_id VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_BF3C146AD2900468 (ontology_id), INDEX IDX_BF3C146AB03A8386 (created_by_id), INDEX IDX_BF3C146A7C6441BA (parent_term_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE kinship_algorithm (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, parent_term_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, ontology_id VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_F6C3F273D2900468 (ontology_id), INDEX IDX_F6C3F273B03A8386 (created_by_id), INDEX IDX_F6C3F2737C6441BA (parent_term_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE metabolic_trait (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, parent_term_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, ontology_id VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, chebi_mono_iso_topic_mass NUMERIC(10, 2) DEFAULT NULL, chebi_mass NUMERIC(10, 2) DEFAULT NULL, synonym LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', chebi_link VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_D5205C83D2900468 (ontology_id), INDEX IDX_D5205C83B03A8386 (created_by_id), INDEX IDX_D5205C837C6441BA (parent_term_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE method_class (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_543119ECB03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pedigree (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, pedigree_cross_id INT DEFAULT NULL, pedigree_entry_id VARCHAR(255) DEFAULT NULL, generation VARCHAR(255) DEFAULT NULL, ancestor_pedigree_entry_id VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_C36D0C7AB03A8386 (created_by_id), INDEX IDX_C36D0C7A8614D5A8 (pedigree_cross_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE qtlmethod (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, parent_term_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, ontology_id VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8A46E100D2900468 (ontology_id), INDEX IDX_8A46E100B03A8386 (created_by_id), INDEX IDX_8A46E1007C6441BA (parent_term_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE season (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_F0E45BA9B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE software (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, parent_term_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, ontology_id VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_77D068CFD2900468 (ontology_id), INDEX IDX_77D068CFB03A8386 (created_by_id), INDEX IDX_77D068CF7C6441BA (parent_term_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE storage_type (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, code VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_85F39C3CB03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE structure_method (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, parent_term_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, ontology_id VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_47E0DD4AD2900468 (ontology_id), INDEX IDX_47E0DD4AB03A8386 (created_by_id), INDEX IDX_47E0DD4A7C6441BA (parent_term_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE study (id INT AUTO_INCREMENT NOT NULL, trial_id INT DEFAULT NULL, factor_id INT DEFAULT NULL, season_id INT DEFAULT NULL, institute_id INT DEFAULT NULL, location_id INT DEFAULT NULL, growth_facility_id INT DEFAULT NULL, parameter_id INT DEFAULT NULL, experimental_design_type_id INT DEFAULT NULL, created_by_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, start_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, cultural_practice VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, last_updated DATETIME DEFAULT NULL, observation_units_description VARCHAR(255) DEFAULT NULL, experimental_design_description VARCHAR(255) DEFAULT NULL, INDEX IDX_E67F97495596D5F7 (trial_id), INDEX IDX_E67F9749BC88C1A3 (factor_id), INDEX IDX_E67F97494EC001D1 (season_id), INDEX IDX_E67F9749697B0F4C (institute_id), INDEX IDX_E67F974964D218E (location_id), INDEX IDX_E67F9749DEDA642A (growth_facility_id), INDEX IDX_E67F97497C56DBD6 (parameter_id), INDEX IDX_E67F974914EF4924 (experimental_design_type_id), INDEX IDX_E67F9749B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE threshold_method (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, parent_term_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, ontology_id VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_3F5986E2D2900468 (ontology_id), INDEX IDX_3F5986E2B03A8386 (created_by_id), INDEX IDX_3F5986E27C6441BA (parent_term_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE trait_class (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, parent_term_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, ontology_id VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_9DEA4BD7D2900468 (ontology_id), INDEX IDX_9DEA4BD7B03A8386 (created_by_id), INDEX IDX_9DEA4BD77C6441BA (parent_term_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE trait_processing (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_766E312BB03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE trial_type (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, parent_term_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, ontology_id VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_48F74508B03A8386 (created_by_id), INDEX IDX_48F745087C6441BA (parent_term_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE unit (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, parent_term_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, ontology_id VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_DCBB0C53D2900468 (ontology_id), INDEX IDX_DCBB0C53B03A8386 (created_by_id), INDEX IDX_DCBB0C537C6441BA (parent_term_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE anatomical_entity ADD CONSTRAINT FK_4759D4C7C6441BA FOREIGN KEY (parent_term_id) REFERENCES anatomical_entity (id)');
        ...
        $this->addSql('ALTER TABLE developmental_stage ADD CONSTRAINT FK_E0FDDCD47C6441BA FOREIGN KEY (parent_term_id) REFERENCES developmental_stage (id)');
        ...
        $this->addSql('ALTER TABLE experimental_design_type ADD CONSTRAINT FK_5720C9747C6441BA FOREIGN KEY (parent_term_id) REFERENCES experimental_design_type (id)');
        $this->addSql('ALTER TABLE factor_type ADD CONSTRAINT FK_8CFAE03BB03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE factor_type ADD CONSTRAINT FK_8CFAE03B7C6441BA FOREIGN KEY (parent_term_id) REFERENCES factor_type (id)');
        ...
        $this->addSql('ALTER TABLE metabolic_trait ADD CONSTRAINT FK_D5205C837C6441BA FOREIGN KEY (parent_term_id) REFERENCES metabolic_trait (id)');
        ...
        $this->addSql('ALTER TABLE trait_class ADD CONSTRAINT FK_9DEA4BD77C6441BA FOREIGN KEY (parent_term_id) REFERENCES trait_class (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE anatomical_entity DROP FOREIGN KEY FK_4759D4C7C6441BA');
        ...
        $this->addSql('ALTER TABLE developmental_stage DROP FOREIGN KEY FK_E0FDDCD47C6441BA');
        ...
        $this->addSql('ALTER TABLE experimental_design_type DROP FOREIGN KEY FK_5720C9747C6441BA');
        $this->addSql('ALTER TABLE study DROP FOREIGN KEY FK_E67F974914EF4924');
        $this->addSql('ALTER TABLE factor_type DROP FOREIGN KEY FK_8CFAE03B7C6441BA');
        ...
        $this->addSql('ALTER TABLE metabolic_trait DROP FOREIGN KEY FK_D5205C837C6441BA');
        ...
        $this->addSql('ALTER TABLE trait_class DROP FOREIGN KEY FK_9DEA4BD77C6441BA');
