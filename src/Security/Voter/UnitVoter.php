...
class UnitVoter extends Voter
{
    ...
    protected function supports(string $attribute, $unit): bool
    {
        ...
        return in_array($attribute, [self::EDIT, self::DEL])
            && $unit instanceof \App\Entity\Unit;
    }
    ...
    protected function voteOnAttribute(string $attribute, $unit, TokenInterface $token): bool
    {
        ...
        switch ($attribute) {
            ...
            case self::DEL:
                ...
                // return true or false
                return $this->canDelete($unit, $user);
                break;
        }
     ...
     private function canEdit(Unit $unit, User $user){
        ...
        return $user === $unit->getCreatedBy();
    }

    private function canDelete(Unit $unit, User $user){
