...
class ContactVoter extends Voter
{
    ...
    public const DEL = 'contact_delete';
    ...
    protected function supports(string $attribute, $contact): bool
    {
        // replace with your own logic
        // https://symfony.com/doc/current/security/voters.html
        return in_array($attribute, [self::EDIT, self::DEL])
            && $contact instanceof \App\Entity\Contact;
    }
    ...
    protected function voteOnAttribute(string $attribute, $contact, TokenInterface $token): bool
    {
        ...
        switch ($attribute) {
            ...
            case self::DEL:
                ...
                // return true or false
                return $this->canDelete($contact, $user);
                break;
        }
    ...
    private function canDelete(Contact $contact, User $user){
