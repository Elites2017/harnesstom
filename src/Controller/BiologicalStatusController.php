        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            foreach ($sheetData as $key => $row) {
                ...
                if ($label != null && $code != null) {
                    ...
                    $existingBiologicalStatus = $entmanager->getRepository(BiologicalStatus::class)->findOneBy(['label' => $label]);
                    ...
                    if (!$existingBiologicalStatus) {
                        ...
                        $biologicalStatus->setLabel($label);
                        $biologicalStatus->setCode($code);
                        $biologicalStatus->setParentTerm($parentTerm);
                        $biologicalStatus->setIsActive(true);
                        $biologicalStatus->setCreatedAt(new \DateTime());
                        $entmanager->persist($biologicalStatus);
                    }
