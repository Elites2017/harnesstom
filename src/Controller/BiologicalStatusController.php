            ...
            foreach ($sheetData as $key => $row) {
                ...
                if ($ontology_id != null && $name != null) {
                    ...
                    if (!$existingBiologicalStatus) {
                        ...
                        $biologicalStatusOntologyIdParentTerm = $entmanager->getRepository(BiologicalStatus::class)->findOneBy(['ontology_id' => $parentTerm]);
                        if (($biologicalStatusOntologyIdParentTerm != null) && ($biologicalStatusOntologyIdParentTerm instanceof \App\Entity\BiologicalStatus)) {
                            $biologicalStatus->setParentTerm($biologicalStatusOntologyIdParentTerm);
                        }
                        if ($this->getUser()) {
                            $biologicalStatus->setCreatedBy($this->getUser());
                        }
