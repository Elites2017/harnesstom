...
class KinshipAlgorithm
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=User::class, inversedBy="kinshipAlgorithms")
     */
    private $createdBy;

    /**
     * @ORM\OneToMany(targetEntity=GWAS::class, mappedBy="kinshipAlgorithm")
     */
    private $gWAS;
    ...
    public function removeGWA(GWAS $gWA): self
    {
        if ($this->gWAS->removeElement($gWA)) {
            ...
            if ($gWA->getKinshipAlgorithm() === $this) {
                $gWA->setKinshipAlgorithm(null);
            }
        }
